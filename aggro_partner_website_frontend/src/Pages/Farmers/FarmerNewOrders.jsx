...
import { FarmerNewOrderData } from './FarmerNewOrderData'
import CallIcon from '@mui/icons-material/Call';
import DateRangeIcon from '@mui/icons-material/DateRange';
import { Label } from '@mui/icons-material';
import { getFarmerNewOrdersByFarmerId } from '../../Services/FarmerService';

const FarmerNewOrders = () => {
  ...
  useEffect(()=>{
    getFarmerNewOrdersByFarmerId(setFarmerId).then((response)=>{
    ...
    <div>
      <div className='m-[6rem]'>
        ...
        <section className='relative items-center justify-center flex mt-20 bg-gray-100 '>
            <h1 className='text-4xl font-bold p-5'>New Order's</h1>
        </section>
...
export default FarmerNewOrders
